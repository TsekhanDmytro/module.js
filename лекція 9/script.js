...
//     bloc.innerText =` ${element.title} ${element.monthDuration}`
// }
...
//     blok.appendChild(elementH1);
//     blok.appendChild(elementP);
// }
...
//     document.body.appendChild(bloc)
//
//     let fulName = document.createElement('h2')
//     fulName.innerText = `${simpson.name} ${simpson.surname}: ${simpson.age} years`
//     bloc.appendChild(fulName)
//
...
for (const coursesArrayElement of coursesArray) {
    let ollCursDiv = document.createElement('div');
    let cursDiv = document.createElement('div');
    let titleDiv = document.createElement('div');
    let monthHouerDiv = document.createElement('div');
    let memberListDiv = document.createElement('div');
    let memberListUl = document.createElement('ul')
    for (const element of coursesArrayElement.modules) {
        let memberListLi = document.createElement('li');
        memberListLi.innerHTML= element;
        memberListUl.appendChild(memberListLi);
    }
    titleDiv.innerText = `Title:${coursesArrayElement.title}`;
    monthHouerDiv.innerText = `Mouns: ${coursesArrayElement.monthDuration}, Houer: ${coursesArrayElement.hourDuration}`;
    document.body.appendChild(ollCursDiv);
    ollCursDiv.appendChild(cursDiv);
    cursDiv.appendChild(titleDiv);
    cursDiv.appendChild(monthHouerDiv);
    cursDiv.appendChild(memberListDiv);
    memberListDiv.appendChild(memberListUl);
}